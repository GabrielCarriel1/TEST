"""
Django settings for my_test2 project.
...
SECRET_KEY = 'django-insecure-+=zi_$8oy-coljwla(-qz2)f-t9k4*-9af027dcr&4dm3pmlqw'
...
WSGI_APPLICATION = 'my_test2.wsgi.application'
